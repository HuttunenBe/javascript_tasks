...
let zooAnimals2 = ["Elephant", "Giraffe", "Panda", "Fox", "Kangaroo"];
let index = zooAnimals2.indexOf("Giraffe");
zooAnimals2[index] = "Cheetah";
...
let attendees2 = ["John", "Sarah", "John", "Alex", "John"];
let upperCaseAttendees = attendees2.map((attendees2) => attendees2.toUpperCase());
